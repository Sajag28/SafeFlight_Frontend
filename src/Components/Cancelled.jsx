...
import Plane from '../assets/flight7.png'
import {
  Card,
  CardContent,
  Typography,
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      try {
        ...
        const res = await axios.post("http://localhost:8000/security/Users/Cancelled/", {
          passport: passport
        });
...
>
    ...
    <Typography variant="h3">Your Cancelled Bookings</Typography>
</Stack>
